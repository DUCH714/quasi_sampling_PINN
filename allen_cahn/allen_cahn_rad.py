"""
Allen-Cahn Equation Solver using Physics-Informed Neural Networks (PINNs) with RAD.

This module implements a PINN-based solution for the Allen-Cahn equation:
    f = u - u^3 + ∇² u

Usage:
    Training mode:  python allen_cahn_rad.py --mode train --network mlp --dim 100
    Evaluation mode: python allen_cahn_rad.py --mode eval --network mlp --dim 100
"""
